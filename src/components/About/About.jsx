...
const About = () => {
  // context
  let words=['I"m a new frontend developer with a passion for designing user interfaces using React. I have a strong understanding of HTML, CSS, and JavaScript and I"m able to optimize websites for better user experiences. I have the ability to work independently or as part of a team to complete projects. I keep up to date with the latest front-end trends and believe that I will continue to develop my skills with React.']
  const transition = {
    duration: 2,
    type: "spring",
  };
  ...
  return (
    <div className="about" id="about">
      ...
      { <motion.div
        ...
        >
           <img src={img__about} alt="img-s2" className="img-about" />
        </motion.div>}
      </div>
      <div className="w-right">
        <div className="awesome__about">
            ...
            <spane className="awesome__spane">
              ...
              /> 
            <Link to="contact" smooth={true} spy={true} className="btn-about">
