...
const Services = () => {
  ...
  let words=['I am a frontend developer specializing in React with experience in HTML, CSS, and JavaScript. I have the ability to work independently or in a team, and always prioritize optimizing user experience and page load speed.']
  // transition
  const transition = {
    duration: 1,
    type: "spring",
